...
public:
    ...
    class Interface
    {
        friend class Ltc2945;

        virtual void write(uint8_t address, uint8_t reg, std::span<const uint8_t> data) = 0;
        virtual void read(uint8_t address, uint8_t reg, std::span<uint8_t> data) = 0;
    };

public:
    Ltc2945(Interface* interface, Address address, float resistance);
